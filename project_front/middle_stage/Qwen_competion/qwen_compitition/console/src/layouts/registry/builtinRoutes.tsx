...
const TravelPlannerPage = lazyImportWithRetry("../../pages/TravelPlanner");
const TravelAlbumPage = lazyImportWithRetry("../../pages/TravelAlbum");
const LensGoDashboardPage = lazyImportWithRetry(
  "../../pages/LensGoDashboard",
);
...
export const BUILTIN_ROUTES: Route[] = [
  ...
  {
    id: "core.travel-planner",
    path: "/travel-planner",
    component: TravelPlannerPage,
  },
  { id: "core.travel-album", path: "/travel-album", component: TravelAlbumPage },
  { id: "core.lensgo", path: "/lensgo", component: LensGoDashboardPage },
