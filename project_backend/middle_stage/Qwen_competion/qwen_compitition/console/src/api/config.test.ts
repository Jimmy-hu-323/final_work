...
describe("getApiUrl", () => {
  ...
  it("uses and normalizes the server selected by the mobile client", () => {
    setApiBaseUrl("  http://192.168.1.9:18088/// ");
    expect(getApiBaseUrl()).toBe("http://192.168.1.9:18088");
    expect(getApiUrl("/models")).toBe(
      "http://192.168.1.9:18088/api/models",
    );
    clearApiBaseUrl();
