...
Source: http://47.82.123.50:18002/
...
| `extracted/tokens.json` | Design tokens: 20 colors, 0 fonts, 13 headings, 0 CTAs |
...
- **Colors**: #17231F (surface-dark), #F5F4EF (bg-light), #FFF0C1 (bg-light), #FFFEFA (bg-light), #FFFFFF (bg-light), #132C24 (accent), #102821 (accent), #F7F5ED (bg-light), #FFF8D7 (bg-light), #43A57F (accent)
- **Fonts**: none detected
